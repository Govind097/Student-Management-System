  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="studentlogin.jsp" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
         login
        </a>
   ...
   <main>
    ...
    <div class="container">
      <h1 class="jumbotron-heading ">Bachelors in Technology</h1>
...
<h2 style="font-size: 24px;" >Bachelors in technology</h2>

<ul class="font-weight-bold" id="">

<li>
<span class="">B.Tech (civil): </span>
<span>4 years Program <br>(Fees: 1-lakh-40-thousands)</span>
</li>

<li>
<span class="">B.Tech (Electronic Communication): </span>
<span>4 years Program <br>(Fees: 1-lakh-50-thousands)</span>
</li>

<li>
<span class="">B.Tech (Information Technology): </span>
<span>4 years Program <br>(Fees: 1-lakh-60-thousands)</span>
</li>

<li>
<span class="">B.Tech (Commuter Science): </span>
<span>4 years Program <br>(Fees: 1-lakh-60-thousands)</span>
</li>
</ul>
</div>
